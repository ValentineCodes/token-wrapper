...
interface IClonedETH is IERC20 {
  /**
   *
  ...
  /**
   *
   * @notice Receives ETH deposit and mints it's equivalent in ClonedETH
   */
  function deposit() external payable;

  /**
   *
   * @notice Transfers {amount} to owner and burns it's equivalent in ClonedETH
