...
function InputTokenAmountForm({label, tokens, value, onChange}: Props) {
  ...
  return (
    <div className='mt-5'>
        ...
        <NumberInput className='flex mt-2'>
            <NumberInputField className='w-full border border-gray-300 pl-2' placeholder='Amount' value={value} onChange={e => handleAmoutChange(Number(e.target.value))} />
